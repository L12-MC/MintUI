 ...
 * - Button UP: D5 (GPIO14) -> GND (with internal pullup)
 * - Button DOWN: D6 (GPIO12) -> GND (with internal pullup)
 * - Button SELECT: D7 (GPIO13) -> GND (with internal pullup)
 * - Button BACK: D3 (GPIO0) -> GND (with internal pullup)
 * 
 * Note: Using GPIO0 (D3) for BACK button instead of GPIO16 (D0)
 * because GPIO16 has limited INPUT_PULLUP support on ESP8266
 * 
...
void setup() {
    ...
    Serial.println("BCK: D3 (GPIO0)");
    Serial.println("\nNote: Using GPIO0 instead of GPIO16 for better compatibility");
    
    // Initialize UI Engine with NodeMCU GPIO pins
    // Button pins: UP(D5/GPIO14), DOWN(D6/GPIO12), SELECT(D7/GPIO13), BACK(D3/GPIO0)
    // Using GPIO0 (D3) instead of GPIO16 (D0) for BACK button - better pullup support
